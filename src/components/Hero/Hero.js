			...
			<div className="hero-box">
				...
				<div className="description">
					<p className="description__p">
						...
						Academy. The program of the course is HTML, CSS (and SASS), JavaScript and React. During the course
					...
					<div className="description__contact">
						<p className="description__contact__paragraf"><Link to={'/contact'}>CONTACT ME</Link></p>
					</div>
				</div>
			</div>
		</>
